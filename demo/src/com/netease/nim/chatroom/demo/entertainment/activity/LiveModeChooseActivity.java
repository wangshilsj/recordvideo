...
//    RelativeLayout audioLiveLayout;
    ...
    private RelativeLayout audioLiveLayout;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.live_mode_choose_activity);
        videoLiveLayout = (RelativeLayout) findViewById(R.id.video_live_layout) ;
        audioLiveLayout = (RelativeLayout) findViewById(R.id.audio_live_layout) ;
        ...
        videoLiveLayout.setOnClickListener(new View.OnClickListener() {
            @Override
        ...
        audioLiveLayout.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
